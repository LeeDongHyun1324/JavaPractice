...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜점 정수 : " + random.nextInt(100));   //int 의 범위 내에서 정수형 값 반환
        System.out.println("랜점 정수 (범위) : " + random.nextInt(10));   //0이상 10미만의 정수형
        System.out.println("랜덤 실수 : " + random.nextDouble());   //0.0이상 1.0미만의 실수형
        //System.out.println("랜점 실수 (범위) : " + random.nextDouble(10.0));    //범위 지정 불가
