...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%.2f%n", Math.PI);   // 3.14  (소수점 두번째 자리까지 반올림)
        System.out.printf("%6.2f%n", Math.PI);  // __3.14   (6칸인데 소수점 두번째 자리까지 반올림)
        ...
        System.out.printf("%6.2s%n", "Java");   // ____Ja 6자리 공간 확보하고 우측 정렬해서 두 글자 출력
        System.out.printf("%-6.2s%n", "Java");  // Ja____ 6자리 공간 확보하고 좌측 정렬해서 두 글자 출력
        ...
        System.out.println("이름      영어   수학   평균"); // 고백이 각각 6, 3, 3칸으로 구분
